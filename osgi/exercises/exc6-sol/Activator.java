 ...
 * under the License.
 */
package org.foo.shape.yellowcircle;
...
public class Activator implements BundleActivator {
  ...
  public void start(BundleContext context) {
    ...
    dict.put(SimpleShape.NAME_PROPERTY, "YellowCircle");
    dict.put(SimpleShape.ICON_PROPERTY, new ImageIcon(this.getClass().getResource("yellowcircle.png")));
    m_context.registerService(SimpleShape.class.getName(), new YellowCircle(), dict);
  }
